    ...
    <div class="d-print-none">
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                <li>
                    <a href="<?= url('qr-codes') ?>"><?= language()->qr_codes->breadcrumb ?></a><i class="fa fa-fw fa-angle-right"></i>
                </li>
                <li class="active" aria-current="page"><?= language()->qr_code_update->breadcrumb ?></li>
            </ol>
        </nav>

        <div class="d-flex align-items-center mb-4">
            <h1 class="h4 text-truncate mb-0 mr-2"><?= language()->qr_code_update->header ?></h1>

            <?= include_view(THEME_PATH . 'views/qr-codes/qr_code_dropdown_button.php', ['id' => $data->qr_code->qr_code_id]) ?>
        </div>
    </div>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="name"><i class="fa fa-fw fa-signature fa-sm mr-1"></i> <?= language()->qr_codes->input->name ?></label>
                        ...
                        <div class="form-group">
                            <label for="project_id">
                                <i class="fa fa-fw fa-project-diagram fa-sm mr-1"></i> <?= language()->projects->project_id ?>
                        ...
                        <div class="form-group">
                            <label for="type"><i class="fa fa-fw fa-qrcode fa-sm mr-1"></i> <?= language()->qr_codes->input->type ?></label>
                            <select id="type" name="type" class="form-control">
                                <?php foreach(array_keys($data->qr_code_settings['type']) as $type): ?>
                                    <option value="<?= $type ?>" <?= $data->qr_code->type == $type ? 'selected="selected"' : null ?>><?= language()->qr_codes->input->{'type_' . $type} ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        ...
                        <div>
                            <div class="form-group" data-type="text">
                                <label for="text"><i class="fa fa-fw fa-paragraph fa-sm mr-1"></i> <?= language()->qr_codes->input->text ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="url">
                                <label for="url"><i class="fa fa-fw fa-link fa-sm mr-1"></i> <?= language()->qr_codes->input->url ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="phone">
                                <label for="phone"><i class="fa fa-fw fa-phone-square-alt fa-sm mr-1"></i> <?= language()->qr_codes->input->phone ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="sms">
                                <label for="sms"><i class="fa fa-fw fa-sms fa-sm mr-1"></i> <?= language()->qr_codes->input->sms ?></label>
                            ...
                            <div class="form-group" data-type="sms">
                                <label for="sms_body"><i class="fa fa-fw fa-paragraph fa-sm mr-1"></i> <?= language()->qr_codes->input->sms_body ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="email">
                                <label for="email"><i class="fa fa-fw fa-envelope fa-sm mr-1"></i> <?= language()->qr_codes->input->email ?></label>
                            ...
                            <div class="form-group" data-type="email">
                                <label for="email_subject"><i class="fa fa-fw fa-heading fa-sm mr-1"></i> <?= language()->qr_codes->input->email_subject ?></label>
                            ...
                            <div class="form-group" data-type="email">
                                <label for="email_body"><i class="fa fa-fw fa-paragraph fa-sm mr-1"></i> <?= language()->qr_codes->input->email_body ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="whatsapp">
                                <label for="whatsapp"><i class="fab fa-fw fa-whatsapp fa-sm mr-1"></i> <?= language()->qr_codes->input->whatsapp ?></label>
                            ...
                            <div class="form-group" data-type="whatsapp">
                                <label for="whatsapp_body"><i class="fa fa-fw fa-paragraph fa-sm mr-1"></i> <?= language()->qr_codes->input->whatsapp_body ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="facetime">
                                <label for="facetime"><i class="fa fa-fw fa-headset fa-sm mr-1"></i> <?= language()->qr_codes->input->facetime ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="location">
                                <label for="location_latitude"><i class="fa fa-fw fa-map-pin fa-sm mr-1"></i> <?= language()->qr_codes->input->location_latitude ?></label>
                            ...
                            <div class="form-group" data-type="location">
                                <label for="location_longitude"><i class="fa fa-fw fa-map-pin fa-sm mr-1"></i> <?= language()->qr_codes->input->location_longitude ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="wifi">
                                <label for="wifi_ssid"><i class="fa fa-fw fa-signature fa-sm mr-1"></i> <?= language()->qr_codes->input->wifi_ssid ?></label>
                            ...
                            <div class="form-group" data-type="wifi">
                                <label for="wifi_encryption"><i class="fa fa-fw fa-user-shield fa-sm mr-1"></i> <?= language()->qr_codes->input->wifi_encryption ?></label>
                                <select id="wifi_encryption" name="wifi_encryption" class="form-control" data-reload-qr-code>
                                    ...
                                    <option value="nopass" <?= $data->qr_code->settings->wifi_encryption == 'nopass' ? 'selected="selected"' : null ?>><?= language()->qr_codes->input->wifi_encryption_nopass ?></option>
                                </select>
                            </div>

                            <div class="form-group" data-type="wifi">
                                <label for="wifi_password"><i class="fa fa-fw fa-key fa-sm mr-1"></i> <?= language()->qr_codes->input->wifi_password ?></label>
                            ...
                            <div class="form-group" data-type="wifi">
                                <label for="wifi_is_hidden"><i class="fa fa-fw fa-user-secret fa-sm mr-1"></i> <?= language()->qr_codes->input->wifi_is_hidden ?></label>
                                <select id="wifi_is_hidden" name="wifi_is_hidden" class="form-control" data-reload-qr-code>
                                    <option value="1" <?= $data->qr_code->settings->wifi_is_hidden ? 'selected="selected"' : null ?>><?= language()->global->yes ?></option>
                                    <option value="0" <?= $data->qr_code->settings->wifi_is_hidden ? 'selected="selected"' : null ?>><?= language()->global->no ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="form-group" data-type="event">
                                <label for="event"><i class="fa fa-fw fa-signature fa-sm mr-1"></i> <?= language()->qr_codes->input->event ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_location"><i class="fa fa-fw fa-map-pin fa-sm mr-1"></i> <?= language()->qr_codes->input->event_location ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_url"><i class="fa fa-fw fa-link fa-sm mr-1"></i> <?= language()->qr_codes->input->event_url ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_note"><i class="fa fa-fw fa-paragraph fa-sm mr-1"></i> <?= language()->qr_codes->input->event_note ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_start_datetime"><i class="fa fa-fw fa-calendar fa-sm mr-1"></i> <?= language()->qr_codes->input->event_start_datetime ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_end_datetime"><i class="fa fa-fw fa-calendar fa-sm mr-1"></i> <?= language()->qr_codes->input->event_end_datetime ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_timezone"><i class="fa fa-fw fa-atlas fa-sm mr-1"></i> <?= language()->qr_codes->input->event_timezone ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="crypto">
                                <label for="crypto_coin"><i class="fab fa-fw fa-bitcoin fa-sm mr-1"></i> <?= language()->qr_codes->input->crypto_coin ?></label>
                            ...
                            <div class="form-group" data-type="crypto">
                                <label for="crypto_address"><i class="fa fa-fw fa-coins fa-sm mr-1"></i> <?= language()->qr_codes->input->crypto_address ?></label>
                        ...
                        <div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group" data-type="vcard">
                                        <label for="vcard_first_name"><i class="fa fa-fw fa-signature fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_first_name ?></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group" data-type="vcard">
                                        <label for="vcard_last_name"><i class="fa fa-fw fa-signature fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_last_name ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_phone"><i class="fa fa-fw fa-phone-square-alt fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_phone ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_email"><i class="fa fa-fw fa-envelope fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_email ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_url"><i class="fa fa-fw fa-link fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_url ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_company"><i class="fa fa-fw fa-building fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_company ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_job_title"><i class="fa fa-fw fa-user-tie fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_job_title ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_birthday"><i class="fa fa-fw fa-birthday-cake fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_birthday ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_street"><i class="fa fa-fw fa-road fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_street ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_city"><i class="fa fa-fw fa-city fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_city ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_zip"><i class="fa fa-fw fa-mail-bulk fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_zip ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_region"><i class="fa fa-fw fa-flag fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_region ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_country"><i class="fa fa-fw fa-globe fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_country ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_note"><i class="fa fa-fw fa-paragraph fa-sm mr-1"></i> <?= language()->qr_codes->input->vcard_note ?></label>
                            ...
                            <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#vcard_socials_container" aria-expanded="false" aria-controls="vcard_socials_container" data-type="vcard">
                                <?= language()->qr_codes->input->vcard_socials ?>
                            </button>
                            ...
                            <div class="collapse" id="vcard_socials_container" data-type="vcard">
                                ...
                                <?php foreach($data->qr_code->settings->vcard_socials ?? [] as $key => $social): ?>
                                    <div class="mb-4">
                                        <div class="form-group" data-type="vcard">
                                            <label for="<?= 'vcard_social_label_' . $key ?>"><?= language()->qr_codes->input->vcard_social_label ?></label>
                                        ...
                                        <div class="form-group" data-type="vcard">
                                            <label for="<?= 'vcard_social_value_' . $key ?>"><?= language()->qr_codes->input->vcard_social_value ?></label>
                                ...
                                <div class="mb-3">
                                    <button data-add="vcard_social" type="button" class="btn btn-sm btn-outline-success"><i class="fa fa-fw fa-plus-circle"></i> <?= language()->global->create ?></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#colors_container" aria-expanded="false" aria-controls="colors_container">
                            <i class="fa fa-fw fa-palette fa-sm mr-1"></i> <?= language()->qr_codes->input->colors ?>
                        </button>

                        <div class="collapse" id="colors_container">
                            <div class="form-group">
                                <label for="foreground_type"><i class="fa fa-fw fa-paint-roller fa-sm mr-1"></i> <?= language()->qr_codes->input->foreground_type ?></label>
                                <select id="foreground_type" name="foreground_type" class="form-control" data-reload-qr-code>
                                    <option value="color" <?= $data->qr_code->settings->foreground_type == 'color' ? 'selected="selected"' : null?>><?= language()->qr_codes->input->foreground_type_color ?></option>
                                    <option value="gradient" <?= $data->qr_code->settings->foreground_type == 'gradient' ? 'selected="selected"' : null?>><?= language()->qr_codes->input->foreground_type_gradient ?></option>
                                </select>
                            </div>

                            <div class="form-group" data-foreground-type="color">
                                <label for="foreground_color"><i class="fa fa-fw fa-paint-brush fa-sm mr-1"></i> <?= language()->qr_codes->input->foreground_color ?></label>
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                <label for="foreground_gradient_style"><i class="fa fa-fw fa-brush fa-sm mr-1"></i> <?= language()->qr_codes->input->foreground_gradient_style ?></label>
                                <select id="foreground_gradient_style" name="foreground_gradient_style" class="form-control" data-reload-qr-code>
                                    ...
                                    <option value="<?= $style ?>" <?= $data->qr_code->settings->foreground_gradient_style == $style ? 'selected="selected"' : null?>><?= language()->qr_codes->input->{'foreground_gradient_style_' . $style} ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>

                            <div class="form-group" data-foreground-type="gradient">
                                <label for="foreground_gradient_one"><?= language()->qr_codes->input->foreground_gradient_one ?></label>
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                <label for="foreground_gradient_two"><?= language()->qr_codes->input->foreground_gradient_two ?></label>
                            ...
                            <div class="form-group">
                                <label for="background_color"><?= language()->qr_codes->input->background_color ?></label>
                            ...
                            <div class="form-group">
                                <label for="background_color_transparency"><?= language()->qr_codes->input->background_color_transparency ?></label>
                            ...
                            <div class="form-group">
                                <label for="custom_eyes_color"><i class="fa fa-fw fa-eye fa-sm mr-1"></i> <?= language()->qr_codes->input->custom_eyes_color ?></label>
                                <select id="custom_eyes_color" name="custom_eyes_color" class="form-control" data-reload-qr-code>
                                    <option value="1" <?= $data->qr_code->settings->custom_eyes_color == '1' ? 'selected="selected"' : null?>><?= language()->global->yes ?></option>
                                    <option value="0" <?= $data->qr_code->settings->custom_eyes_color == '0' ? 'selected="selected"' : null?>><?= language()->global->no ?></option>
                                </select>
                            </div>

                            <div class="form-group" data-custom-eyes-color="1">
                                <label for="eyes_inner_color"><?= language()->qr_codes->input->eyes_inner_color ?></label>
                            ...
                            <div class="form-group" data-custom-eyes-color="1">
                                <label for="eyes_outer_color"><?= language()->qr_codes->input->eyes_outer_color ?></label>
                        ...
                        <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#branding_container" aria-expanded="false" aria-controls="branding_container">
                            <i class="fa fa-fw fa-copyright fa-sm mr-1"></i> <?= language()->qr_codes->input->branding ?>
                        </button>

                        <div class="collapse" id="branding_container">
                            <div class="form-group">
                                <label for="qr_code_logo"><i class="fa fa-fw fa-sm fa-eye text-muted mr-1"></i> <?= language()->qr_codes->input->qr_code_logo ?></label>
                                ...
                                <?php endif ?>
                                <input id="qr_code_logo" type="file" name="qr_code_logo" accept="<?= \Altum\Uploads::get_whitelisted_file_extensions_accept('qr_code_logo') ?>" class="form-control-file" data-reload-qr-code />
                                <small class="form-text text-muted"><?= sprintf(language()->global->accessibility->whitelisted_file_extensions, \Altum\Uploads::get_whitelisted_file_extensions_accept('qr_code_logo')) ?></small>
                            </div>

                            <div class="form-group">
                                <label for="qr_code_logo_size"><i class="fa fa-fw fa-expand-alt fa-sm mr-1"></i> <?= language()->qr_codes->input->qr_code_logo_size ?></label>
                        ...
                        <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#options_container" aria-expanded="false" aria-controls="options_container">
                            <i class="fa fa-fw fa-wrench fa-sm mr-1"></i> <?= language()->qr_codes->input->options ?>
                        </button>

                        <div class="collapse" id="options_container">
                            <div class="form-group">
                                <label for="size"><i class="fa fa-fw fa-expand-arrows-alt fa-sm mr-1"></i> <?= language()->qr_codes->input->size ?></label>
                            ...
                            <div class="form-group">
                                <label for="margin"><i class="fa fa-fw fa-expand fa-sm mr-1"></i> <?= language()->qr_codes->input->margin ?></label>
                            ...
                            <div class="form-group">
                                <label for="ecc"><i class="fa fa-fw fa-check fa-sm mr-1"></i> <?= language()->qr_codes->input->ecc ?></label>
                                <select id="ecc" name="ecc" class="form-control" data-reload-qr-code>
                                    <?php foreach(['L', 'M', 'Q', 'H'] as $level): ?>
                                        <option value="<?= $level ?>" <?= $data->qr_code->settings->ecc == $level ? 'selected="selected"' : null ?>><?= language()->qr_codes->input->{'ecc_' . mb_strtolower($level)} ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="row mb-4 d-print-none">
                <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                    <button type="button" onclick="window.print()" class="btn btn-block btn-outline-secondary d-print-none">
                        <i class="fa fa-fw fa-sm fa-file-pdf"></i> <?= language()->qr_codes->print ?>
                    </button>
                </div>

                <div class="col-12 col-lg-6">
                    <a href="<?= UPLOADS_FULL_URL . 'qr_code/' . $data->qr_code->qr_code ?>" id="download" download="<?= $data->qr_code->name . '.svg' ?>" target="_blank" class="btn btn-block btn-primary d-print-none">
                        <i class="fa fa-fw fa-sm fa-download"></i> <?= language()->qr_codes->download ?>
                    </a>
                </div>
            </div>
            ...
            <div class="mb-4 text-center d-print-none">
                <small>
                    <i class="fa fa-fw fa-info-circle text-muted mr-1"></i> <span class="text-muted"><?= language()->qr_codes->info ?></span>
                </small>
            </div>
        </div>
    </div>
...
<template id="template_vcard_social">
    <div class="mb-4">
        <div class="form-group">
            <label for=""><?= language()->qr_codes->input->vcard_social_label ?></label>
        ...
        <div class="form-group">
            <label for=""><?= language()->qr_codes->input->vcard_social_value ?></label>

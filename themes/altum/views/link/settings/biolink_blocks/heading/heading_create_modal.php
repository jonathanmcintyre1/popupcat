    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= language()->create_biolink_heading_modal->header ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_text" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="heading_heading_type"><?= language()->create_biolink_heading_modal->heading_type ?></label>
                    ...
                    <div class="form-group">
                        <label for="heading_text"><i class="fa fa-fw fa-heading fa-sm mr-1"></i> <?= language()->create_biolink_heading_modal->text ?></label>

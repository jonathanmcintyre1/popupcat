    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= language()->create_biolink_link_modal->header ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_link" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="link_location_url" type="text" class="form-control" name="location_url" required="required" maxlength="512" placeholder="<?= language()->create_biolink_link_modal->input->location_url_placeholder ?>" />
                    </div>

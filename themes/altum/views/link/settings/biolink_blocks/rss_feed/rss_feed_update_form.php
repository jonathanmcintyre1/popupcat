...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        ...
        <input id="<?= 'rss_feed_location_url_' . $row->biolink_block_id ?>" type="text" class="form-control" name="location_url" value="<?= $row->location_url ?>" maxlength="512" placeholder="<?= language()->create_biolink_rss_feed_modal->location_url_placeholder ?>" required="required" />
    </div>

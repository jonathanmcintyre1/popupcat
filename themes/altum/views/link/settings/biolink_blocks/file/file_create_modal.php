    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= language()->create_biolink_file_modal->header ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_file" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="file_file"><i class="fa fa-fw fa-file fa-sm mr-1"></i> <?= language()->create_biolink_file_modal->file ?></label>
                        <input id="file_file" type="file" name="file" accept="<?= implode(', ', array_map(function($value) { return '.' . $value; }, $data->biolink_blocks['file']['whitelisted_file_extensions'])) ?>" class="form-control-file" required="required" />
                        <small class="form-text text-muted"><?= language()->create_biolink_file_modal->file_help ?></small>
                    </div>

                    <div class="form-group">
                        <label for="file_name"><i class="fa fa-fw fa-paragraph fa-sm mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>

        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_biolink_image_grid" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="image_grid_image_alt"><i class="fa fa-fw fa-comment-dots fa-sm mr-1"></i> <?= language()->create_biolink_link_modal->input->image_alt ?></label>
                    ...
                    <div class="form-group">
                        <label for="image_grid_location_url"><i class="fa fa-fw fa-link fa-sm mr-1"></i> <?= language()->create_biolink_link_modal->input->location_url ?></label>
                        <input id="image_grid_location_url" type="text" class="form-control" name="location_url" maxlength="512" />
                    </div>

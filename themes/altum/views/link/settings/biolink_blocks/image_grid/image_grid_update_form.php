...
<form name="update_biolink_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="<?= 'image_grid_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paragraph fa-sm mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'image_grid_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-image fa-sm mr-1"></i> <?= language()->create_biolink_image_grid_modal->image ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'image_grid_image_alt_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-comment-dots fa-sm mr-1"></i> <?= language()->create_biolink_link_modal->input->image_alt ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'image_grid_location_url_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-link fa-sm mr-1"></i> <?= language()->create_biolink_link_modal->input->location_url ?></label>
        <input id="<?= 'image_grid_location_url_' . $row->biolink_block_id ?>" type="text" class="form-control" name="location_url" value="<?= $row->location_url ?>" maxlength="512" />
    </div>

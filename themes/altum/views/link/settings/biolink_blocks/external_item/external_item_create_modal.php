            ...
            <div class="modal-body">
                <form name="create_biolink_external_item" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="external_item_location_url" type="text" class="form-control" name="location_url" required="required" maxlength="512" placeholder="<?= language()->create_biolink_link_modal->input->location_url_placeholder ?>" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="external_item_price" type="text" name="price" maxlength="32" class="form-control" value="" placeholder="<?= language()->create_biolink_external_item_modal->price_placeholder ?>" required="required" />
                    </div>

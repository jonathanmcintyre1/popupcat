            ...
            <div class="modal-body">
                <form name="create_link" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="location_url"><i class="fa fa-fw fa-signature fa-sm mr-1"></i> <?= language()->create_link_modal->input->location_url ?></label>
                        <input id="location_url" type="text" class="form-control" name="location_url" maxlength="512" required="required" placeholder="<?= language()->create_link_modal->input->location_url_placeholder ?>" />
                    </div>

...
<div class="d-flex justify-content-between mb-4">
    <h1 class="h3"><i class="fa fa-fw fa-xs fa-adjust text-primary-900 mr-2"></i> <?= language()->admin_pixels->header ?></h1>
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    <div class="dropdown-header d-flex justify-content-between">
                        ...
                        <?php if(count($data->filters->get)): ?>
                            <a href="<?= url('admin/pixels') ?>" class="text-muted"><?= language()->global->filters->reset ?></a>
                        <?php endif ?>
                    </div>
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="search_by" id="filters_search_by" class="form-control form-control-sm">
                                <option value="name" <?= $data->filters->search_by == 'name' ? 'selected="selected"' : null ?>><?= language()->admin_pixels->filters->search_by_name ?></option>
                            </select>
                        </div>

                        <div class="form-group px-4">
                            <label for="filters_type" class="small"><?= language()->admin_pixels->filters->type ?></label>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                ...
                                <option value="name" <?= $data->filters->order_by == 'name' ? 'selected="selected"' : null ?>><?= language()->admin_pixels->filters->order_by_name ?></option>
                            </select>
                        </div>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <tr>
                ...
                <th><?= language()->admin_pixels->table->user ?></th>
                <th><?= language()->admin_pixels->table->name ?></th>
                <th><?= language()->admin_pixels->table->type ?></th>
                <th><?= language()->admin_pixels->table->datetime ?></th>
                <th></th>
            </tr>
            </thead>
            <tbody>
            ...
            <?php foreach($data->pixels as $row): ?>
                ...
                <tr>
                    ...
                    <td>
                        <?= include_view(THEME_PATH . 'views/admin/pixels/admin_pixel_dropdown_button.php', ['id' => $row->pixel_id]) ?>
                    </td>
                </tr>
            <?php endforeach ?>
...
<?php \Altum\Event::add_content(include_view(THEME_PATH . 'views/admin/pixels/pixel_delete_modal.php'), 'modals'); ?>

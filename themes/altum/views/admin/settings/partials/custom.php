...
<div>
    ...
    <div class="form-group">
        <label for="head_js_biolink"><i class="fab fa-fw fa-sm fa-js text-muted mr-1"></i> <?= language()->admin_settings->custom->head_js_biolink ?></label>
    ...
    <div class="form-group">
        <label for="head_css_biolink"><i class="fab fa-fw fa-sm fa-css3 text-muted mr-1"></i> <?= language()->admin_settings->custom->head_css_biolink ?></label>

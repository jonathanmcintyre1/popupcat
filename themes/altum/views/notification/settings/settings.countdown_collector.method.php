...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_end_date"><?= language()->notification->settings->end_date ?></label>
        <input type="text" id="settings_end_date" name="end_date" class="form-control" value="<?= \Altum\Date::get($data->notification->settings->end_date, 1) ?>" autocomplete="off" required="required" />
    </div>
...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_content_title_color"><?= language()->notification->settings->content_title_color ?></label>
        <div class="input-group">
            <div class="input-group-prepend">
                <div id="settings_content_title_color_pickr"></div>
            </div>
            <input type="text" id="settings_content_title_color" name="content_title_color" class="form-control border-left-0" value="<?= $data->notification->settings->content_title_color ?>" required="required" />
        </div>
    </div>

    <div class="form-group">
        <label for="settings_time_color"><?= language()->notification->settings->time_color ?></label>
        <div class="input-group">
            <div class="input-group-prepend">
                <div id="settings_time_color_pickr"></div>
            </div>
            <input type="text" id="settings_time_color" name="time_color" class="form-control border-left-0" value="<?= $data->notification->settings->time_color ?>" required="required" />
        </div>
    </div>

    <div class="form-group">
        <label for="settings_time_background_color"><?= language()->notification->settings->time_background_color ?></label>
        <div class="input-group">
            <div class="input-group-prepend">
                <div id="settings_time_background_color_pickr"></div>
            </div>
            <input type="text" id="settings_time_background_color" name="time_background_color" class="form-control border-left-0" value="<?= $data->notification->settings->time_background_color ?>" required="required" />
        </div>
    </div>
...
<script>
    ...
    /* Daterangepicker */
    let locale_options = <?= json_encode(require APP_PATH . 'includes/daterangepicker_translations.php') ?>;

    $('#settings_end_date').daterangepicker({
        minDate: new Date(),
        singleCalendar: true,
        timePicker: true,
        ...
        locale: {...locale_options, format: 'YYYY-MM-DD HH:mm:ss'},
    }, (start, end, label) => {
    });

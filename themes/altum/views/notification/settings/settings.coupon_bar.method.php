...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_coupon_code"><?= language()->notification->settings->coupon_code ?></label>
...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_coupon_code_color"><?= language()->notification->settings->coupon_code_color ?></label>
        <div class="input-group">
            <div class="input-group-prepend">
    ...
    <div class="form-group">
        <label for="settings_coupon_code_background_color"><?= language()->notification->settings->coupon_code_background_color ?></label>
        <div class="input-group">
            <div class="input-group-prepend">
    ...
    <div class="form-group">
        <label for="settings_coupon_code_border_color"><?= language()->notification->settings->coupon_code_border_color ?></label>
        <div class="input-group">
            <div class="input-group-prepend">

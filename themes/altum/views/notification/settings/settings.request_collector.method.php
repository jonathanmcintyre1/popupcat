...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_content_description_color"><?= language()->notification->settings->content_description_color ?></label>
        <div class="input-group">
            <div class="input-group-prepend">
                <div id="settings_content_description_color_pickr"></div>
            </div>
            <input type="text" id="settings_content_description_color" name="content_description_color" class="form-control border-left-0" value="<?= $data->notification->settings->content_description_color ?>" required="required" />
        </div>
    </div>
